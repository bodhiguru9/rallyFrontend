import type { CountryCode } from './WhatsAppInput.types';

// Comprehensive list of countries where WhatsApp is available
// UAE is first as it's the default
export const countryCodes: CountryCode[] = [
  ...
  { code: '+1649', country: 'Turks and Caicos', flag: '🇹🇨' },
  { code: '+1664', country: 'Montserrat', flag: '🇲🇸' },
  { code: '+1670', country: 'Northern Mariana', flag: '🇲🇵' },
...
// Find UAE index for default selection
export const defaultCountryIndex = countryCodes.findIndex((c) => c.code === '+971');
export const defaultCountry = countryCodes[defaultCountryIndex >= 0 ? defaultCountryIndex : 0];
