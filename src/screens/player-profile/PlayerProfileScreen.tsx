...
import { PlayerProfileQRModal } from './components/PlayerProfileQRModal';
import { ENV } from '@config';
import type { RootStackParamList } from '@navigation';
import { styles } from './style/PlayerProfileScreen.styles';
import { getUserInitials } from '@utils';
import { images } from '@assets/images';
import { ArrowIcon } from '@components/global/ArrowIcon';

type PlayerProfileScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'PlayerProfile'
>;
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        >
          <TextDs size={12} color="error" weight='semibold'>Sign Out</TextDs>
        </Pressable>
      </ScrollView>
      ...
      {/* Share Player Profile QR Code Modal */}
      <PlayerProfileQRModal
        visible={showQRModal}
        profileLink={`${ENV.RALLY_WEB_BASE_URL}player/${user.id}`}
